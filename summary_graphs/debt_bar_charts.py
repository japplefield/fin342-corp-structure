...
for sector in unique_sectors:
    ...
    ax.text(0.5, -0.05, f'Median Quarterly Debt Change / Normalized EBITDA for {sector}', ha="center", va="top", transform=ax.transAxes)
    ...
    plt.savefig(f'Debt_Bar_Charts/med_debt_cng_ebitda_{sector.replace(" ", "_")}.png')
...
fig.autofmt_xdate()
ax.legend()
plt.savefig('Debt_Bar_Charts/med_debt_cng_ebitda_all.png')
