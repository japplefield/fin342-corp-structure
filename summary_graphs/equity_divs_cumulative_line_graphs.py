...
for sector in unique_sectors:
    ...
    plt.tight_layout()
    plt.savefig(f'Equity_Cumulative_Line_Charts/med_eq_divs_cng_ebitda_cum_{sector.replace(" ", "_")}.png')
...
plt.savefig('Equity_Cumulative_Line_Charts/med_eq_divs_cng_ebitda_cum_all.png')
