...
plt.title('Median Cumulative Debt Change/Normalized EBITDA for Airlines')
plt.tight_layout()
...
plt.title('Median Cumulative Equity Change/Normalized EBITDA for Airlines')
plt.tight_layout()
labelLines(plt.gca().get_lines())
...
plt.title('Median Cumulative Equity Change from Dividends/Normalized EBITDA for Airlines')
plt.tight_layout()
labelLines(plt.gca().get_lines())
...
plt.title('Median Cumulative Equity Change from Share Issuance (Repurchase)/Normalized EBITDA for Airlines')
plt.tight_layout()
labelLines(plt.gca().get_lines())
